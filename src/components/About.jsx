  ...
  return (
    <div className='abtContainer'>
      <div>
        ...
        <p style={{marginTop: 20}}>Before anything else, here’s a little bit about myself. My name is Yang Zi Chien（杨谨铨）. I was born on 10th March 2005, currently an 18-year-old fresh graduate from HinHua High School, a Chinese independent high school in Malaysia. I studied in the business stream, and before I took a fancy to computer programming, my ambition was, and still is, to start my own business in the future and be a great leader. Hence, I would like to learn more in regards to leadership and entrepreneurship skills.</p>
